...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Viewport
    ref={ref}
    className={cn(
      'fixed bottom-20 right-4 z-[100] flex max-h-screen w-full flex-col gap-2 p-4 md:max-w-[420px]',
      className,
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Title
    ref={ref}
    className={cn('text-sm font-semibold [.destructive_&]:text-white [.success_&]:text-white', className)}
    {...props}
  />
))
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Description
    ref={ref}
    className={cn('text-sm opacity-90 [.destructive_&]:text-white [.success_&]:text-white', className)}
    {...props}
  />
))
